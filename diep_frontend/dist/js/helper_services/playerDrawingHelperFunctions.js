export const drawPlayerObject = (ctx, player) => {
    // draw the inside
    ctx.beginPath();
...
export const drawBarrel = (ctx, player) => {
    // border
    ctx.beginPath();
...
export const drawNameBar = (ctx, player) => {
...
export const drawLifeBar = (ctx, player) => {
    const borderWidth = 6;
    const maxLife = 100;
...
export const drawObstacleLifeBar = (ctx, obstacle) => {
    const borderWidth = 6;
